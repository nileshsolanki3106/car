...
<td align="center"><img class="img1" src="admin/product/<?php echo $row['file']; ?>" width="28rem" height="25rem"  class="k" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   <div style="margin-right:100px"><a  style="color:#000033; font-size:22px; font-weight:700" href="detail.php?id=<?php echo $row['supplier_product_id']?>"><?php echo $row['product_name']; ?></a></div>&nbsp;
    ...
    <div style="color:#000033;margin-right:100px"><!--<?php echo $row['accessories']; ?>-->
      <p><a href="order.php?p_id=<?php echo $row['supplier_product_id']; ?>">Order Now</a><a href="product_detail.php?p_id=<?php echo $row['supplier_product_id']; ?>" class="btn btn-primary" style="margin-left:20px;" ><font size="1px">click for information</font></a></p>
